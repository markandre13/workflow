...
describe("figures", function () {
    describe("Path", function () {
        ...
        describe("create SVG Path", function () {
            ...
            describe("succesive anchors", function() {

                it("E E E -> M L L", function() {
                    const path = new Path()
                    path.addEdge(p0)
                    path.addEdge(p1)
                    path.addEdge(p2)
